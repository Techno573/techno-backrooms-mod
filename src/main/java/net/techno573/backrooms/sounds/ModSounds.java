...
public class ModSounds {
    ...
    public static void registerSounds() {
        System.out.println("Registering Mod Sounds for" + Main.MOD_ID);
    }

    public static LiminalTravelSound travelSoundRegister = LiminalSoundRegistry.registerOverride(Main.id("travel_glitch"), new ModTravelSound());
}
