...
public class ModWorld {
    ...
    //Effects List
    public static final LiminalEffects LEVEL_0_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    public static final LiminalEffects LEVEL_1_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(new ReverbSettings().setEnabled(true).setDecayTime(1.25f).setDensity(1.25f)));
    public static final LiminalEffects LEVEL_2_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(new ReverbSettings().setEnabled(true).setDecayTime(1.5f).setDensity(1.25f)));
    public static final LiminalEffects LEVEL_3_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(new ReverbSettings().setEnabled(true).setDecayTime(1.25f).setDensity(1.25f)));
    public static final LiminalEffects LEVEL_4_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(),  Optional.empty());
    public static final LiminalEffects LEVEL_5_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(new ReverbSettings().setEnabled(true).setDecayTime(1.25f).setDensity(1.25f)));
    public static final LiminalEffects LEVEL_6_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.of(new ReverbSettings().setEnabled(true).setDecayTime(1.25f).setDensity(1.25f)));
    public static final LiminalEffects LEVEL_FUN_EFFECTS = new LiminalEffects(Optional.of(new LiminalBaseEffects.SimpleBaseEffects(Optional.empty(), false, "NONE", false, false, false)), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
