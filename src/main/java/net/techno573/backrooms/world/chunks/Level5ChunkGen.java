...
public class Level5ChunkGen extends AbstractNbtChunkGenerator {

    public static final Codec<Level5ChunkGen> CODEC = RecordCodecBuilder.create((level5ChunkGenInstance -> level5ChunkGenInstance.group(BiomeSource.CODEC.fieldOf("biome_source").stable().forGetter(
    ...
    public Level5ChunkGen(BiomeSource biomeSource, long worldSeed) {
        super(new SimpleRegistry<StructureSet>(Registry.STRUCTURE_SET_KEY, Lifecycle.stable(), null), Optional.empty(), biomeSource, biomeSource, worldSeed, BackroomsMod.id("level_5"), LiminalUtil.createMultiNoiseSampler());    }
    ...
    public ChunkGenerator withSeed(long seed) {
        return new Level5ChunkGen(this.biomeSource,seed);
    }
