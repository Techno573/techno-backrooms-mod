...
public class Level1ChunkGen extends AbstractNbtChunkGenerator {

    public static final Codec<Level1ChunkGen> CODEC = RecordCodecBuilder.create((level1ChunkGenInstance -> level1ChunkGenInstance.group(BiomeSource.CODEC.fieldOf("biome_source").stable().forGetter(
    ...
    public ChunkGenerator withSeed(long seed) {
        return new Level1ChunkGen(this.biomeSource,seed);
    }
