...
public class PartygoerEntity extends HostileEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public PartygoerEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected SoundEvent getAmbientSound() {
        ...
        return ModSounds.PARTYGOER_GIGGLES;
    }
    ...
    private <partygoerEntity extends IAnimatable>PlayState predicate(AnimationEvent<partygoerEntity> event) {
